<div class="overflow-hidden">
    <div class="max-w-full px-5 overflow-x-auto">
        <table class="min-w-full">
            ...
            <tbody>
                <template x-for="(transfer, index) in paginatedtransfer" :key="transfer.id">
                    <tr>
                        <td
                        ...
                        <td
                            :class="index === paginatedtransfer.length - 1 ? 'px-4 py-4 whitespace-nowrap' :
                                'px-4 py-4 whitespace-nowrap border-b border-gray-200 dark:border-gray-700'">
                            <div class="flex text-sm text-gray-900 dark:text-white gap-1" x-text="transfer.from_account">
                            </div>
                        </td>
                        <td
                            :class="index === paginatedtransfer.length - 1 ? 'px-4 py-4 whitespace-nowrap' :
                                'px-4 py-4 whitespace-nowrap border-b border-gray-200 dark:border-gray-700'">
                            <div class="text-sm text-gray-900 dark:text-white" x-text="transfer.to_account">
                            </div>
                        </td>
                        <td
                            :class="index === paginatedtransfer.length - 1 ? 'px-4 py-4 whitespace-nowrap' :
                                'px-4 py-4 whitespace-nowrap border-b border-gray-200 dark:border-gray-700'">
                            <div class="text-sm text-gray-900 dark:text-white" x-text="transfer.description">
                            </div>
                        </td>
                        <td
                            :class="index === paginatedtransfer.length - 1 ? 'px-4 py-4 whitespace-nowrap' :
