        ...
        <div class="relative h-[108vh] w-full bg-[linear-gradient(to_bottom,#D9E7F6_43%,#B5CFED_100%)] dark:bg-[linear-gradient(to_bottom,#1E293B,#0F172A)]">
            ...
            <div class="flex flex-1 pt-35 pl-31">
                <div class="w-[45%] flex flex-col gap-10">
                    ...
                    <a href="{{ route('login') }}" class="bg-accent w-40 h-15 rounded-full text-lg flex items-center justify-center text-white/90">
                        Get Started
                    </a>
                </div>
            ...
            <div class="absolute bottom-0 w-full h-[120px] bg-white dark:bg-gray-900 rounded-t-[100%]"></div>
        </div>
        <div class="h-screen">
        </div>
        <!-- Toggler -->
