...
@section('content')
    <div class="relative z-1 bg-white p-6 sm:p-0 dark:bg-gray-900">
        <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
            ...
            <div
                class="bg-[linear-gradient(to_bottom,#D9E7F6_43%,#B5CFED_100%)] relative hidden h-full w-full items-center lg:grid lg:w-1/2 dark:bg-[linear-gradient(to_bottom,#1E293B,#0F172A)]">
